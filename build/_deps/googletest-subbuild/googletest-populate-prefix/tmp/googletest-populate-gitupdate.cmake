...
execute_process(
  COMMAND "D:/Environmen/Git/cmd/git.exe" --git-dir=.git show-ref "v1.15.2"
  WORKING_DIRECTORY "D:/work/AAA_21ic_Project/MedicalOCR/build/_deps/googletest-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/work/AAA_21ic_Project/MedicalOCR/build/_deps/googletest-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/work/AAA_21ic_Project/MedicalOCR/build/_deps/googletest-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
